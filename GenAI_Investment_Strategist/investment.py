...
os.environ["GOOGLE_API_KEY"] = "AIzaSyCNjSpv-asaGVT4L4VAj-TVcfHLxAXjzRI"
...
def get_company_info(symbol):
    ...
    try:
        ...
        print(f"Could not retrieve company info for {symbol}. Reason: {str(e)}")
        info = {}
    return {
...
def get_company_news(symbol):
    ...
    try:
        ...
        print(f"Could not retrieve news for {symbol}. Reason: {str(e)}")
        news = []
    return news
